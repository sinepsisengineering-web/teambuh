// server/routes/servicesRoutes.ts
// API маршруты для услуг и комплексов

const express = require('express');
const router = express.Router();

let getServicesDatabase: any = null;
try {
...
router.get('/api/:tenantId/services', (req: any, res: any) => {
...
router.get('/api/:tenantId/services/:id', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
...
router.post('/api/:tenantId/services', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
...
router.delete('/api/:tenantId/services/:id', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
...
// POST /api/:tenantId/services/:id/restore — восстановить услугу из архива
router.post('/api/:tenantId/services/:id/restore', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
...
router.get('/api/:tenantId/packages', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
...
router.get('/api/:tenantId/packages/:id', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
...
router.post('/api/:tenantId/packages', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
...
router.delete('/api/:tenantId/packages/:id', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
...
// POST /api/:tenantId/packages/:id/restore — восстановить комплекс из архива
router.post('/api/:tenantId/packages/:id/restore', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
...
router.get('/api/:tenantId/services-stats', (req: any, res: any) => {
    if (!getServicesDatabase) {
        return res.status(503).json({ error: 'Services database not available' });
    }
    try {
